...
class BaseMessageRecipient(_PrismaModel):
    __prisma_model__: ClassVar[Literal['MessageRecipient']] = 'MessageRecipient'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.MessageRecipientActions[_PrismaModelT]':
        from .client import get_client

        return actions.MessageRecipientActions[_PrismaModelT](client or get_client(), cls)
